              ...
              <CDBSidebarContent className="sidebar-content">
                <CDBSidebarMenu>
                  ...
                  <NavLink exact to="/admin/user" activeClassName="activeClicked">
                    <CDBSidebarMenuItem icon="group-people">Manage Users</CDBSidebarMenuItem>
                  </NavLink>
                  <NavLink exact to="/admin/stats" activeClassName="activeClicked">
                    <CDBSidebarMenuItem icon="chart-bar">Statistics</CDBSidebarMenuItem>
                  </NavLink>
                  ...
                  <NavLink exact to="/admin/profile" activeClassName="activeClicked">
                    <CDBSidebarMenuItem icon="bell" >Notification<span class="badge rounded-pill badge-notification bg-danger">{datacount}</span></CDBSidebarMenuItem>
                  </NavLink>
                  <NavLink exact activeClassName="activeClicked">
                    <CDBSidebarMenuItem icon="sign-out" onClick={submit}>Logout</CDBSidebarMenuItem>
                  </NavLink>
